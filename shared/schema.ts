...
export const conversations = pgTable("conversations", {
  ...
  type: text("type").default("chat"), // "chat" or "build"
  projectName: text("project_name"), // For build type conversations
  projectDescription: text("project_description"), // For build type
  buildStatus: text("build_status").default("pending"), // "pending", "building", "completed", "failed"
  isActive: boolean("is_active").default(true),
...
export const semanticMemory = pgTable("semantic_memory", {
  ...
  memoryType: text("memory_type").default("conversation"),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});

// New table for project files generated by AI
export const projectFiles = pgTable("project_files", {
  id: serial("id").primaryKey(),
  conversationId: integer("conversation_id").references(() => conversations.id).notNull(),
  messageId: integer("message_id").references(() => messages.id), // Which AI message generated this file
  filename: text("filename").notNull(),
  filePath: text("file_path").notNull(), // Relative path in project
  content: text("content").notNull(), // The actual file content
  language: text("language"), // "html", "css", "js", "python", etc.
  purpose: text("purpose"), // "component", "stylesheet", "logic", etc.
  generatedBy: text("generated_by").notNull(), // personality nameId
